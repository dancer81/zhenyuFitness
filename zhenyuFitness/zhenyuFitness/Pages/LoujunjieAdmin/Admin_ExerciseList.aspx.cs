...
{
    public partial class Admin_ExerciseList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.tableShow += "<tr class=\"gradeB\"" + "onclick =" + string.Format("javascript:window.open('Admin_ExerciseEdit.aspx?exerciseID={0}')", Common.Common.ObjectToString(dt.Rows[i]["ID"])) + ">" +
